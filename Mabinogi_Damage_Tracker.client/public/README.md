...
Dot Net:  
	This should already come packaged with your windows computer. But if you run into issues just download the newest .net from microsoft and you should be able to run.  
...
Open 'localhost:3000' in a web browser on the tracker PC and you should see the web page load after a slight wait.  
The app is fully functional at this point in time (note1) but if you would like to open the web page on another computer, your phone, or port forward / tunnel / reverse proxy the app so your friends can access the web page you need to continue to the settings page.
In the settings page, add the local IP of the tracker PC and you can select the correct network adapter to skip the scanning function on boot.  

(note1) We monitor healing, general chat, and damage. Check the live page for a live log that you can determine if your getting data. If you see an error logged in the live page saying no adapter could be connected make sure you start the app with Mabinogi open and in the world with a character. You can restart the connection in the settings menu and once you find the correct adapter you can save that adapter in the settings menu so next time the software is opened the scanning process can be skipped.


##We are an open source project and appreciate any contributions to the project! Currently the main missing feature set is redoubled offensive and star dust information not being read. We are also actively developing the user experience and adding front end features. Check back with the repo occasionally and see if any new updates are out.



# Recognitions:

KilloPillers - Lead front end designer, data presentation and user experience, backend data collection and overall major project lead.
&ensp; https://github.com/KilloPillers  
Anonymous Devs - All around assistance.  
LukasTD - NaoParse - foundation for beginning this project with great resources.  
&ensp; https://github.com/LukasTD/NaoParse  
Exectails - Morrighan & MabiPale2 - which was the foundation for NaoParse.  
&ensp; https://github.com/exectails  
Pril - dilmatulgi - The Korean version of NaoParse with additional information on parsing packets.  
&ensp; https://gitlab.com/prilus/mabidilmeter  
The following projects were used as reference to set up chat message parsing  
Riskdoe - mabi_guild_chat_sniffer  
&ensp; https://github.com/riskdoe  
Pandurx - Discord-Mabinogi-Bot  
&ensp; https://github.com/pandurx  
Shanefully-done - Mabicord-AIO  
&ensp; https://github.com/shanefully-done  
